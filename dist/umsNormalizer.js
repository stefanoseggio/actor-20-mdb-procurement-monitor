...
import { NOTES_ON_DEBARRED_FIRMS_FALLBACK_URL, WORLD_BANK_DEBARRED_FIRMS_URL, } from './sources/worldBankDebarredFirms.js';
...
// -----------------------------------------------------------------------
export function normalizeWorldBankProcurementNotice(raw, scrapedAt, isNew, eventType = 'NEW_LISTING') {
...
// -----------------------------------------------------------------------
export function normalizeWorldBankOtherSanction(raw, scrapedAt) {
 ...
 */
export function buildDebarredFirmsDegradedNotice(scrapedAt, degradedReason) {
    return {
